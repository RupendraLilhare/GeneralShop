...
public class Ecomerce_tc_2 extends BaseClass {
	...
	public void fillform()
	{
		...
		String toast_sms=driver.findElement(By.xpath("//android.widget.Toast[1]")).getAttribute("name");
		
		System.out.println(toast_sms);
		
		Assert.assertEquals(toast_sms,"Please enter your name");
